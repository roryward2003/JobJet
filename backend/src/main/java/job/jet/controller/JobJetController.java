...
import job.jet.service.CareerService;
import job.jet.dto.CareerDto;
...
@CrossOrigin
@RestController
@RequestMapping("/jobjet")
@Tag(name = "Job Jet", description = "APIs for retrieving and modifying Profiles and Careers")
// Annotation for OpenAPI/Swagger
// See configuration in class OpenApiConfig in package config
// Access at http://localhost:8080/swagger-ui.html
public class JobJetController {
    // Create logger for this class
    private static final Logger logger = LoggerFactory.getLogger(JobJetController.class);

    private final CareerService careerService;
    private final ProfileService profileService;

    public JobJetController(CareerService careerService, ProfileService profileService) {
    ...
    //
    // GET mapping to "/id" for retrieving a user's ID based on the auth token and username.
    //
    @Operation(
